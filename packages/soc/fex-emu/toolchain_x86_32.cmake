# Cross-toolchain for FEX's i686 GUEST thunk libraries; see toolchain_x86_64.cmake.
# 32-bit C++ headers live under the gcc triple's /32 subdir.
set(CMAKE_EXE_LINKER_FLAGS_INIT "-fuse-ld=lld")
set(CMAKE_MODULE_LINKER_FLAGS_INIT "-fuse-ld=lld")
set(CMAKE_SHARED_LINKER_FLAGS_INIT "-fuse-ld=lld -lstdc++")
set(CMAKE_C_COMPILER clang)
set(CMAKE_CXX_COMPILER clang++)
# clang's i686 sysroot search does not include Arch's /usr/lib32, so -lstdc++ needs it explicitly.
