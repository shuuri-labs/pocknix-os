...
| MED→done? | mangoapp/MangoHud metrics | Added `--mangoapp` to the gamescope launch + `mangohud` dep (provides `mangoapp`). Testing. GPU stats likely partial on Adreno/msm; FPS/CPU/frametime should show. |
